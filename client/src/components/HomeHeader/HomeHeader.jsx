...
const HomeHeader = () => {
  ...
  usePopupClose(close, setSearchUser);
  usePopupClose(close, setNotificationUser);
  usePopupClose(close, setHeaderMore);
  ...
  return (
    <>
      <div className="ins-header">
        <div className="ins-hearder-wraper">
          ...
          {searchUser && <InsIcon />}
          {notificationUser && <InsIcon />}
          <div className="header-menu">
            <ul>
              <li onClick={handleHome}>
                <Link
                  to="/"
                  className={`${homeHeader.home ? "activeBtn" : false}`}
                >
              ...
              <li onClick={handleSearch}>
                <a href="#">
                  <div
                    className={`${searchUser ? "activeShow" : "active-option"}`}
                  >
                    {!searchUser && (
                      <svg
                        aria-label="Search"
              ...
              <li onClick={() => setNotificationUser(!notificationUser)}>
                <a href="#">
                  <div
                    className={`${
                      notificationUser ? "activeShow" : "active-option"
                    }`}
                  >
                    {!notificationUser && (
                      <svg
              ...
              <li onClick={() => setHeaderMore(!headerMore)}>
                <a href="#">
                  <div
                    className={`${
                      notificationUser ? "activeShow" : "active-option"
          ...
          {searchUser && <SearchUser close={close} />}
          {notificationUser && <NotificationUser close={close} />}
          {headerMore && <HeaderMore close={close} />}
        </div>
      </div>
    </>
  );
